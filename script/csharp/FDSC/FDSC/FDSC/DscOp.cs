...
namespace DscOp
{
	...
	public class DscFile : IBinarySerializable
	{
		...
		public void BinSerialize(Stream s, bool close = true)
		{
		...
		public static DscFile BinDeserialize(Stream s, bool close = true)
		{
			BinarySerializer serializer = new BinarySerializer();
			DscFile dsc = (DscFile)serializer.Deserialize(s, typeof(DscFile));
			if (!close) { s.Close(); }
			return dsc;
		}

		public void XmlSerialize(Stream s, bool close = true)
		{
		...
		public static DscFile XmlDeserialize(Stream s, bool close = true)
		{
			XmlSerializer serializer = new XmlSerializer(typeof(DscFile));
